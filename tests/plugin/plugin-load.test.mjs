 ...
 *   - the `tool` object exposes exactly the 33 named tool
 *     definitions (16 delivery + 17 workflow)
 *
 * The canonical 33-tool set is imported from
...
test("plugin: registers exactly 33 tools", async () => {
  const mod = await import(pluginPath);
  const fakeCtx = {
