...
description: Hand an approved implementation plan to ship_deliver. Use when the user approves a plan or says implement this plan. Never implement or commit in this session.
---
...
3. Ensure a GitHub issue exists: call `delivery_issue` with
   ...
   Print `Track: issue #N.`
4. Call `ship_deliver` with that `issueNumber`.
